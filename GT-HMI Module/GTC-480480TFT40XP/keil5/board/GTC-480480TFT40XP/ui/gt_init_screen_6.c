...
gt_obj_st * gt_init_screen_6(void)
{
	...
	gt_screen_set_bgcolor(screen_6, gt_color_hex(0xFFFFFF));
	...
	gt_img_set_src(img1, "f:img_480x480_318.png");

	

	/** img2 */
	/** 返回图标 */
	img2 = gt_img_create(screen_6);
	...
	gt_img_set_src(img6, "f:img_60x60_612.png");
	gt_obj_add_event_cb(img6, img6_0_cb, GT_EVENT_TYPE_INPUT_PRESSED, NULL);
	

	/** slider1 */
	/** 温度调整滑动条 */
	slider1 = gt_slider_create(screen_6);
	gt_obj_set_pos(slider1, 93, 120);
	gt_obj_set_size(slider1, 50, 170);
	gt_slider_set_start_end(slider1, 16, 33);
	gt_slider_set_pos(slider1, 22);
	gt_slider_set_color_act(slider1, gt_color_hex(0xf80998));
	...
	/** rect2 */
	/** 模式底部矩形框 */
	rect2 = gt_rect_create(screen_6);
	gt_obj_set_pos(rect2, 300, 114);
	gt_obj_set_size(rect2, 80, 36);
	gt_rect_set_radius(rect2, 20);
	gt_rect_set_bg_color(rect2, gt_color_hex(0xf80998));
	gt_rect_set_color_border(rect2, gt_color_hex(0xf80998));
	...
	/** lab2 */
	/** 送风文字，24号，4Bit */
	lab2 = gt_label_create(screen_6);
	gt_obj_set_pos(lab2, 316, 113);
	...
	gt_label_set_text(lab2, "送风");

	

	/** lab4 */
	/** 当前室内温度文字，矢量16号，4bit */
	lab4 = gt_label_create(screen_6);
	gt_obj_set_pos(lab4, 274, 269);
	gt_obj_set_size(lab4, 150, 24);
	...
	gt_label_set_text(lab4, "当前室内温度22度");
	...
	/** lab6 */
	lab6 = gt_label_create(screen_6);
	gt_obj_set_pos(lab6, 257, 163);
