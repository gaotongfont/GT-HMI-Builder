...
gt_obj_st * gt_init_screen_home(void)
{
	...
	gt_img_set_src(img1, ".:img_480x480_bj.png");
	...
	gt_img_set_src(img2, ".:img_204x112_270.png");
	...
	gt_img_set_src(img3, ".:img_204x112_267.png");
	...
	gt_img_set_src(img4, ".:img_204x112_268.png");
	...
	gt_img_set_src(img5, ".:img_204x112_269.png");
