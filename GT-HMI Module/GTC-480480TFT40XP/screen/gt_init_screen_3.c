...
gt_obj_st * gt_init_screen_3(void)
{
	...
	gt_img_set_src(img18, "f:img_480x480_1.png");
	...
	gt_img_set_src(img19, "f:img_15x26_187.png");
	...
	gt_img_set_src(img20, "f:img_104x42_616.png");
	...
	gt_img_set_src(img21, "f:img_104x42_618.png");
	...
	gt_img_set_src(img22, "f:img_104x42_614.png");
	...
	gt_img_set_src(img23, "f:img_289x289_403.png");
