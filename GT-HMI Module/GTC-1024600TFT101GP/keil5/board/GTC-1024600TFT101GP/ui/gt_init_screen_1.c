...
gt_obj_st * gt_init_screen_1(void)
{
	...
	gt_img_set_src(img1, "f:img_184x208_1.png");
	...
	gt_img_set_src(img2, "f:img_184x208_2.png");
	...
	gt_img_set_src(img3, "f:img_184x208_3.png");
	...
	gt_img_set_src(img4, "f:img_44x63_10.png");
	...
	gt_img_set_src(img5, "f:img_184x208_4.png");
	...
	gt_img_set_src(img6, "f:img_184x208_5.png");
	...
	gt_img_set_src(img7, "f:img_184x208_6.png");
