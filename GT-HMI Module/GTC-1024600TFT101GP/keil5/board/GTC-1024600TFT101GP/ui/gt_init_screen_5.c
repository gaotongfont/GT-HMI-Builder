...
gt_obj_st * gt_init_screen_5(void)
{
	...
	gt_img_set_src(img2, "f:img_869x76_21.png");
	...
	gt_img_set_src(img3, "f:img_869x77_22.png");
	...
	gt_img_set_src(img4, "f:img_869x77_23.png");
	...
	gt_img_set_src(img5, "f:img_869x76_24.png");
