...
gt_obj_st * gt_init_screen_home(void)
{
	...
	gt_img_set_src(img1, ".:img_480x272_hjzx1.png");
	...
	gt_imgbtn_set_src(imgbtn1, ".:img_160x41_sy_n_160x410x231.png");
	gt_imgbtn_add_state_item(imgbtn1, ".:img_160x41_sy_n_160x410x231.png");
	...
	gt_imgbtn_set_src(imgbtn3, ".:img_160x41_yyzx_p_160x41320x231.png");
