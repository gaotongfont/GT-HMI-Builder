...
gt_obj_st * gt_init_screen_home(void)
{
	...
	gt_img_set_src(img1, "f:img_480x272_hjzx1.png");
	...
	gt_imgbtn_set_src(imgbtn1, "f:img_160x41_sy_n_160x410x231.png");
	gt_imgbtn_add_state_item(imgbtn1, "f:img_160x41_sy_n_160x410x231.png");
	...
	gt_imgbtn_set_src(imgbtn2, "f:img_160x41_xy.png");
