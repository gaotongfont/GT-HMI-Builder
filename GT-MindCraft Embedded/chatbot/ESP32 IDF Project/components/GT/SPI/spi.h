...
/* 引脚定义 */
#define SPI_MOSI_GPIO_PIN   GPIO_NUM_42//GPIO_NUM_13//LCD_MOSI_GPIO//GPIO_NUM_11         /* SPI2_MOSI */
#define SPI_CLK_GPIO_PIN    GPIO_NUM_1         /* SPI2_CLK */
#define SPI_MISO_GPIO_PIN   (-1)         /* SPI2_MISO */
