...
gt_obj_st * gt_init_screen_11(void)
{
	...
	/** imgbtn1 */
	/** 暂停/播放图标 */
	imgbtn1 = gt_imgbtn_create(screen_11);
	...
	/** slider1 */
	/** 时间滑动条 */
	slider1 = gt_slider_create(screen_11);
	...
	/** img4 */
	/** 音量图标 */
	img4 = gt_img_create(screen_11);
	gt_obj_set_pos(img4, 14, 133);
	gt_obj_set_size(img4, 24, 24);
	gt_img_set_src(img4, ".:img_24x24_85_volume_notice.png");

	

	/** clock1 */
	/** 播放倒计时 */
	clock1 = gt_clock_create(screen_11);
	gt_obj_set_pos(clock1, 238, 131);
	...
	/** lab1 */
	/** 快乐文字，优黑20x20 */
	lab1 = gt_label_create(screen_11);
	gt_obj_set_pos(lab1, 34, 13);
	gt_obj_set_size(lab1, 100, 30);
