...
gt_obj_st * gt_init_screen_home(void)
{
	...
	gt_img_set_src(img1, ".:img_30x30_70_wifi_medium.png");
	...
	gt_img_set_src(img2, ".:img_26x26_2_battery_regular.png");
	...
	gt_imgbtn_set_src(imgbtn1, ".:img_84x84_1_c.png");
	...
	gt_imgbtn_set_src(imgbtn2, ".:img_84x84_2_c.png");
	...
	gt_imgbtn_set_src(imgbtn3, ".:img_84x84_0_c.png");
	...
	gt_img_set_src(img3, ".:img_18x15_4_c.png");
