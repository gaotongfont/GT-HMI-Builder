...
gt_obj_st * gt_init_screen_7(void)
{
	...
	gt_player_add_item(player6, "f:img_20x20_v4_icon.png", sizeof("f:img_20x20_v4_icon.png"));
	gt_player_add_item(player6, "f:img_20x20_v5_icon.png", sizeof("f:img_20x20_v5_icon.png"));
	gt_player_add_item(player6, "f:img_20x20_v6_icon.png", sizeof("f:img_20x20_v6_icon.png"));
	...
	gt_img_set_src(img2, "f:img_20x20_61_chevron_down.png");
