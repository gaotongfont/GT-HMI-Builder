...
#define GT_FAMILY_GB18030_16_ST 14
#define GT_FAMILY_GB18030_24_ST 16
#define GT_FAMILY_ASCII_32x32_T 42
#define GT_FAMILY_Number_32x32_SZ 114

typedef enum {
	gt_family_gb18030_16_st = GT_FAMILY_GB18030_16_ST, // 中文宋体
	gt_family_gb18030_24_st = GT_FAMILY_GB18030_24_ST, // 中文宋体
	gt_family_ascii_32x32_t = GT_FAMILY_ASCII_32x32_T, // 英文线性
	gt_family_number_32x32_sz = GT_FAMILY_Number_32x32_SZ, // 数字符号时钟
}font_option_et;
...
/**
* @brief  读取数字符号的点阵数据
* @param  fontcode：		数字符号编码
* @param  font_option：	字体选择
* @param  pbuffer：		存储读取出的点阵数据
* @retval 读取的数据个数	
*/
int GT_Number(unsigned long fontcode, unsigned int font_option, unsigned char* pbuffer);
