...
static const gt_vfs_st virt_file_sys[] ={
    ...
    {"f:img_72x99_1.png", 72, 99, 3082916, 21384, 1},
	{"f:img_72x99_2.png", 72, 99, 3104300, 21384, 1},
	{"f:img_72x99_3.png", 72, 99, 3125684, 21384, 1},
	{"f:img_99x38_8.png", 99, 38, 3147068, 11286, 1},
	{"f:img_99x38_9.png", 99, 38, 3158354, 11286, 1},
    {NULL,0,0,0,0},
};
