...
gt_obj_st * gt_init_screen_home(void)
{
	...
	gt_img_set_src(img1, "f:img_72x99_1.png");
	...
	gt_img_set_src(img2, "f:img_72x99_2.png");
	...
	gt_img_set_src(img3, "f:img_72x99_3.png");
	...
	gt_img_set_src(img4, "f:img_99x38_8.png");
	...
	gt_img_set_src(img5, "f:img_99x38_9.png");
